...
const TeamManagementSection: React.FC = () => {
  ...
  return (
    <HeroCard
      ...
      description="Make it a team effort with SmartTenantAI’s cutting-edge workflow tools. Landlords who use Team Management save up to 9 hours per week on tasks."
      features={features}
      learnMoreLabel=""
      showStamp={false}
