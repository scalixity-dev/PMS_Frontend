...
const LeasePage: React.FC = () => {
  const features = [
    {
      ...
      description:
        "Cast a wider net with a custom website designed to delight potential tenants and keep them engaged.",
    },
    {
      image: "https://res.cloudinary.com/dxwspucxw/image/upload/v1762162431/one_wmo5aa.png",
      title: "Save time listing and leasing",
      description:
        "Every application from your rental listing website goes straight to your SmartTenantAI account, making it easier to track leads, screen tenants, and start onboarding.",
    },
    {
      image: "https://res.cloudinary.com/dxwspucxw/image/upload/v1762162431/one_wmo5aa.png",
      title: "Let the right tenants find you",
      description:
  ...
  const maintenanceFeatures = [
    ...
    {
      image: "",
      title: "Keep Up with Tenant Requests, 24/7",
      description:
  ...
  const inspectionFeatures = [
    {
      ...
      description:
        "Ditch the clipboards and messy paperwork. Simply follow the digital inspection form in SmartTenantAI, share the results, and have them signed online.",
    },
    {
      image: "https://res.cloudinary.com/dxwspucxw/image/upload/v1762162431/one_wmo5aa.png",
  ...
  return (
    <section className="w-full">
      ...
      <SplitHeroFeaturefull
        ...
        description={
          "Whether you're tackling the repair yourself or assigning it out, SmartTenantAI makes it easy. Communicate directly with vendors, landlords, and tenants, reducing response time (and stress)."
        }
      ...
      <SplitHeroFeatureReverse
        ...
        description={
          "A moving tenant has enough on their mind. With SmartTenantAI, you can document everything in minutes, store photos and notes, and keep things stress-free for everyone."
        }
