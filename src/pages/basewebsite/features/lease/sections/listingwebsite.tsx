...
const ListingWebsiteSection: React.FC = () => {
  ...
  return (
    <HeroCard
      ...
      description="Give your tenants an opportunity to boost their credit history by paying rent on time—we’ll even waive the ACH fees as long as they’re enrolled."
      features={features}
      learnMoreLabel=""
      showStamp={false}
