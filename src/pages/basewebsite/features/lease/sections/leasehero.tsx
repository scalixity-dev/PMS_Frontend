...
const LeaseHeroSection: React.FC = () => {
  ...
  return (
    <HeroCard
      ...
      description="Cut down on paperwork and save up to 20 hours a week with SmartTenantAI’s built-in lease templates. Pick from ready-to-go forms or create your own—customize once, reuse every time."
      features={features}
      showStamp={false}
      learnMoreLabel=""
