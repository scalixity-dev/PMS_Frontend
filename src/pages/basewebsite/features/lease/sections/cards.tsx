...
const LeaseCardsSection: React.FC = () => {
  ...
  return (
    <section className="relative w-screen bg-[#0F5132] py-12 sm:py-20 overflow-hidden left-1/2 -translate-x-1/2">
      ...
      {/* Curved white wave at the bottom - flatter on mobile */}
      {/* Mobile: flatter curve */}
      <div className="absolute bottom-0 left-0 w-full h-24 sm:hidden overflow-hidden pointer-events-none">
        <svg
        ...
        >
          <path
            d="M0,120 Q720,60 1440,120 L1440,120 L0,120 Z"
            fill="white"
          />
        </svg>
      </div>
      {/* Tablet/Desktop: original deeper curve */}
      <div className="absolute bottom-0 left-0 w-full h-28 sm:h-32 overflow-hidden pointer-events-none hidden sm:block">
        <svg
          viewBox="0 0 1440 120"
          preserveAspectRatio="none"
          className="w-full h-full"
