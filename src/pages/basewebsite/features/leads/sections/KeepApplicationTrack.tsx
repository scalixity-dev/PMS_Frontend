      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-20 items-stretch">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 w-full h-full">
          {cards.map((card, index) => (
            <div
              key={index}
              className={`group ${card.bgColor} rounded-2xl p-8 flex flex-col justify-between h-full shadow-sm border border-gray-200 transition-all duration-300 ease-in-out cursor-pointer`}
            >
