    ...
    <HeroCard
      ...
      betweenTitleAndDescription={
        <p className="font-heading font-light lg:text-sm xl:text-base leading-[150%] tracking-normal text-subheading mb-3">
          Your calendar at SmartTenantAI will keep you up to date on all of your rentals events such as warranties, recurring maintenance, insurance, lease expiration information, etc.
        </p>
      }
