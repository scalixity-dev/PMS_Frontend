...
const AddReminderModal: React.FC<AddReminderModalProps> = ({ isOpen, onClose, onSave, editReminder, mode = 'add' }) => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            // Send calendar date as YYYY-MM-DD (local) so backend stores it as UTC-noon
            // without TZ drift. Backend normalizes this on both create + update.
            ...
            const reminderDto = {
                ...
                endDate: formData.isRecurring && formData.endDate ? toDateOnly(formData.endDate) : undefined,
