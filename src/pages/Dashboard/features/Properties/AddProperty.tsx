              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <CustomDropdown
                    ...
                    searchable={true}
                    buttonClassName={`bg-white border-gray-200 px-3 py-2 ${submitted && !formData.country ? 'border-red-500' : ''}`}
                  />
                ...
                <div>
                  ...
                  <CustomDropdown
                    ...
                    searchable={true}
                    buttonClassName={`bg-white border-gray-200 px-3 py-2 ${submitted && !formData.stateRegion ? 'border-red-500' : ''}`}
                  />
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <CustomDropdown
                    ...
                    searchable={true}
                    buttonClassName={`bg-white border-gray-200 px-3 py-2 ${submitted && !formData.city ? 'border-red-500' : ''}`}
                  />
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6 mb-6">
                  <div>
                    ...
                    <CustomDropdown
                      ...
                      required
                      buttonClassName={`bg-white border-gray-200 px-3 py-2 ${validationErrors.beds ? 'border-red-500' : ''}`}
                    />
                  ...
                  <div>
                    ...
                    <CustomDropdown
                      ...
                      required
                      buttonClassName={`bg-white border-gray-200 px-3 py-2 ${validationErrors.baths ? 'border-red-500' : ''}`}
                    />
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div>
                    ...
                    <CustomDropdown
                      ...
                      required
                      buttonClassName={`bg-white border-gray-200 px-3 py-2 ${validationErrors.parking ? 'border-red-500' : ''}`}
                    />
                  ...
                  <div>
                    ...
                    <CustomDropdown
                      ...
                      required
                      buttonClassName={`bg-white border-gray-200 px-3 py-2 ${validationErrors.laundry ? 'border-red-500' : ''}`}
                    />
                  ...
                  <div>
                    ...
                    <CustomDropdown
                      ...
                      required
                      buttonClassName={`bg-white border-gray-200 px-3 py-2 ${validationErrors.ac ? 'border-red-500' : ''}`}
                    />
                    {validationErrors.ac && (
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 mb-4">
                      ...
                      <div>
                        ...
                        <CustomDropdown
                          ...
                          required
                          buttonClassName={`bg-white border-gray-200 px-3 py-2 ${validationErrors[`unit_${index}_unitType`] ? 'border-red-500' : ''}`}
                        />
