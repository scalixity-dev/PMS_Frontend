    ...
    return (
        <div className="flex flex-wrap items-center gap-2 md:gap-4 mb-4">
            ...
            <div className="flex items-center gap-2">
                ...
                <button
                    onClick={onAction}
                    className="bg-white border border-[#82D64D] text-gray-600 px-2 md:px-3 py-1.5 md:py-2 rounded-full text-[10px] md:text-xs font-bold flex items-center gap-1 shadow-[inset_0px_3.09px_3.09px_0px_rgba(0,0,0,0.25)]"
                >
                    {actionLabel}
                    <span className='w-3.5 h-3.5 md:w-4 md:h-4 rounded-full flex items-center justify-center text-[#2E6819] text-[10px] border border-[#2E6819] border-2'>
                        <Plus className="w-2.5 h-2.5 md:w-3 md:h-3 text-[#2E6819]" />
                    </span>
                </button>
            </div>
        </div>
