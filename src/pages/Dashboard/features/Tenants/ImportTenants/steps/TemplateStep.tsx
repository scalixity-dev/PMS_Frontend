...
import { generateTenantImportTemplate } from '../utils/generateExcelTemplate';

const TemplateStep: React.FC = () => {
    const handleDownload = () => {
        try {
            generateTenantImportTemplate();
        } catch (error) {
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                ...
                <div className="p-8 bg-[#F3F4F6]">
                    <p className="text-gray-600 mb-6">
                        Use this example to organize the data accordingly before importing your tenants to the system.
                        <br />
