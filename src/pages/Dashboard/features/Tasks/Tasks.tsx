...
const Tasks: React.FC = () => {
    ...
    const mapStatusToBackend = (frontendStatus: string): 'OPEN' | 'IN_PROGRESS' | 'ON_HOLD' | 'RESOLVED' | 'COMPLETED' | 'CANCELLED' => {
        if (frontendStatus === 'Resolved') {
            return 'RESOLVED';
        }
        // Default to OPEN for Active status
        return 'OPEN';
    };
