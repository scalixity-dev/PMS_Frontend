  ...
  useEffect(() => {
    if (unit) {
      setFormData({
        ...
        beds: unit.beds != null ? Number(unit.beds).toString() : '',
        baths: unit.baths != null ? Number(unit.baths).toString() : '',
        size: unit.sizeSqft != null ? Number(unit.sizeSqft).toString() : '',
        rent: unit.rent != null ? Number(unit.rent).toString() : '',
        deposit: unit.deposit != null ? Number(unit.deposit).toString() : '',
