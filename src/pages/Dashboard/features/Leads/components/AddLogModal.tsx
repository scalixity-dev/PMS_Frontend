            ...
            <div className="bg-white rounded-[2rem] w-full max-w-3xl shadow-2xl animate-in zoom-in-95 duration-300 overflow-hidden mx-4">
                ...
                <div className="bg-[#3E706F] px-6 py-4 flex items-center justify-between text-white">
                    <div className="flex items-center gap-3">
                        ...
                        <span className="text-xl font-bold">Log a call</span>
                    </div>
                    <button onClick={onClose} className="hover:bg-white/10 p-1 rounded-full transition-colors">
                        <X size={24} />
                    </button>
                ...
                <div className="p-8 bg-[#F8FAFC]">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
                        ...
                        {/* Call Results */}
                        <div className="space-y-2">
                            <label className="block text-sm font-bold text-[#1A1A1A]">Call Results *</label>
                            <div className="relative">
                                <div className="flex items-center">
                                    <input
                                        ...
                                        className="w-full bg-white border border-gray-100 rounded-2xl px-6 py-3.5 outline-none focus:border-[#3E706F] transition-colors text-gray-700 font-medium placeholder-gray-400"
                                    />
