    ...
    return createPortal(
        ...
        >
            <div
                ...
                className="bg-white rounded-3xl w-full max-w-[95%] sm:max-w-2xl shadow-2xl animate-in zoom-in-95 duration-300 flex flex-col max-h-[90vh] mx-4"
            >
                {/* Header */}
                ...
                {/* Body */}
                <div className="p-4 sm:p-6 bg-[#F8FAFC] rounded-b-3xl overflow-y-auto">
                    {/* Textarea */}
