...
import { LeaseInfoCard } from "../../components/lease/LeaseInfoCard";
import { TenantCard } from "../../components/lease/TenantCard";
                    ...
                    <div className="flex flex-wrap gap-8">
                        {["Tenants", "Leases Transactions", "Agreements & Notices", "Insurance", "Utilities"].map(tab => (
                            <button
                                ...
                                className={`px-6 py-3 font-semibold text-[15px] transition-all relative ${activeTab === tab ? "text-white bg-[#7ED957] rounded-t-lg -mb-[1px]" : "text-gray-400 hover:text-gray-600"}`}
                            >
                                {tab}
                            </button>
                        ))}
