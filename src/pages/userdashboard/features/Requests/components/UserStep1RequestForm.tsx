...
interface UserAdvancedRequestFormProps {
    ...
    useEffect(() => {
        if (initialData && !formTouchedRef.current) {
            ...
            if (initialData.attachments && Array.isArray(initialData.attachments)) {
                initialData.attachments.forEach((file: File) => {
                    restoredMedia.push({
            ...
            if (initialData.video && initialData.video instanceof File) {
                restoredMedia.push({
                    id: crypto.randomUUID(),
                    file: initialData.video,
                    previewUrl: URL.createObjectURL(initialData.video)
                });
            }
    ...
    return (
        <div className="w-full max-w-5xl mx-auto pb-12">
            <div className="mb-6 md:mb-8">
                <h2 className="text-xl md:text-2xl font-bold text-gray-800 mb-2">Category</h2>
            ...
            <div className="mb-6 md:mb-8">
                <h2 className="text-xl md:text-2xl font-bold text-gray-800 mb-2">Issue details</h2>
                <p className="text-gray-500 text-sm">
            ...
            <div className="mb-8 md:mb-12">
                <h2 className="text-xl md:text-2xl font-bold text-gray-800 mb-4">Details</h2>
                <textarea
            ...
            <div className="flex flex-col sm:flex-row gap-8 sm:gap-12 items-center mb-8">
                ...
                <div className="relative w-full sm:w-1/2 lg:w-80">
                    ...
                    <div className="bg-[#F0F0F6] border-2 border-[#7BD747] rounded-[2.5rem] p-6 sm:p-8 pt-10 flex flex-col items-center justify-center h-40 sm:h-48 w-full">
                        <p className="text-[#5C6B7F] text-center font-medium mb-4 text-xs sm:text-sm">Add photos or upload a file</p>
                ...
                <div className="relative w-full sm:w-1/2 lg:w-80">
                    <div className="absolute -top-6 left-1/2 -translate-x-1/2 bg-[#7BD747] text-white px-6 sm:px-10 py-3 rounded-full flex items-center gap-2 font-bold shadow-sm z-10 whitespace-nowrap text-sm sm:text-base">
                        <Video size={18} className="sm:w-5 sm:h-5" strokeWidth={2.5} />
                        <span>Video</span>
                    </div>
                    <div className="bg-[#F0F0F6] border-2 border-[#7BD747] rounded-[2.5rem] p-6 sm:p-8 pt-10 flex flex-col items-center justify-center h-40 sm:h-48 w-full">
                        <p className="text-[#5C6B7F] text-center font-medium mb-4 text-xs sm:text-sm">Take 15 sec. video of the problem</p>
                        <label className="cursor-pointer text-[#2E6819] font-bold text-sm hover:opacity-80 transition-opacity">
                            Choose File
                            <input
                                type="file"
...
export default User__AdvancedRequestForm;
