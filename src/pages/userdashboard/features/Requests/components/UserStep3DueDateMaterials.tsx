...
const UserStep3DueDateMaterials: React.FC<UserStep3DueDateMaterialsProps> = ({ onNext, onBack, initialData }) => {
    ...
    return (
        <div className="w-full max-w-5xl mx-auto pb-12">
            <div className="mb-6 md:mb-8">
                <h2 className="text-xl md:text-2xl font-bold text-gray-800 mb-2">Request Details</h2>
            ...
            <div className="mb-8 md:mb-12 max-w-2xl">
                <h2 className="text-xl md:text-2xl font-bold text-gray-800 mb-2">Materials</h2>
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
                    ...
                    <button
                        ...
                        className="flex items-center justify-between sm:justify-center gap-2 px-6 py-2.5 rounded-full bg-[#3D7475] text-white font-bold hover:opacity-90 transition-opacity w-full sm:w-auto"
                    >
                        <span>Add Row</span>
                                    ...
                                    <div className="flex items-center justify-between md:justify-start gap-4 w-full md:w-auto">
                                        <div className="flex items-center gap-2">
                                            <button
                                                ...
                                                className="w-10 h-10 rounded-md bg-white border-2 border-[#3D7475] flex items-center justify-center text-[#3D7475] hover:bg-[#3D7475] hover:text-white transition-colors"
                                            >
                                                <Minus size={18} />
                                            </button>
...
export default UserStep3DueDateMaterials;
