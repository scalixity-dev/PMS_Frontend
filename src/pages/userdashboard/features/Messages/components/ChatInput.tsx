    ...
    return (
        <div className="bg-white border-t border-gray-200 px-4 py-2.5">
            ...
            <div className="flex items-end gap-3">
                ...
                {/* Text Input */}
                <div className="flex-1 bg-gray-50 rounded-2xl border border-gray-200 focus-within:border-[var(--dashboard-accent)] focus-within:ring-2 focus-within:ring-[var(--dashboard-accent)]/20 transition-all">
                    <textarea
                        ref={textareaRef}
                        value={message}
