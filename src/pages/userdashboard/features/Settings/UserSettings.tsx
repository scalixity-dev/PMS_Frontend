...
const SETTING_CARDS: SettingCardData[] = [
    ...
    },
    {
        ...
        icon: (
            <div className="w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center shrink-0">
                <svg width="36" height="36" viewBox="0 0 56 58" fill="none" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Rental profile icon" className="w-9 h-9 sm:w-11 sm:h-11">
        ...
        links: [
            { label: "Public rental profile", path: "/userdashboard/settings/public-renter-profile" },
        ],
    }
];
