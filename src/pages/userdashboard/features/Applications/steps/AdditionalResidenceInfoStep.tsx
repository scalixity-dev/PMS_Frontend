    ...
    return (
        <div className="w-full">
            <div className="text-center mb-8">
                <h2 className="text-xl font-medium text-[#1A1A1A] mb-1">Additional Residence Info</h2>
                <p className="text-gray-400 text-sm">Any extra details about your living history?</p>
            </div>
            ...
            <div className="flex flex-col items-center">
                <div className="w-full bg-white rounded-2xl p-6 border border-[#E5E7EB] shadow-sm focus-within:border-[#7ED957] focus-within:ring-1 focus-within:ring-[#7ED957]/20 transition-all mb-8">
                    <textarea
                        ...
                        onChange={(e) => updateFormData('additionalResidenceInfo', e.target.value)}
                    />
                </div>
                ...
                <PrimaryActionButton
                    onClick={onNext}
                    text="Next"
                    className="px-16 py-3.5 rounded-full font-bold uppercase transition-all bg-[#7ED957] hover:bg-[#6BC847] shadow-lg shadow-[#7ED957]/30 text-white"
                />
            </div>
        </div>
    );
