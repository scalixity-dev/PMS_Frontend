...
const Settings: React.FC = () => {
    const settingsOptions = [
        ...
        },
        {
            ...
            icon: (
                <div className="w-12 h-12 flex items-center justify-center shrink-0">
                    <svg width="42" height="44" viewBox="0 0 56 58" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    return (
        <div className="min-h-screen bg-white p-6 lg:p-10">
            {/* Breadcrumb */}
            <div className="flex items-center gap-2 text-xl font-medium mb-12 ml-1">
                ...
                <span className="text-[#1A1A1A] font-semibold">Settings</span>
            </div>
