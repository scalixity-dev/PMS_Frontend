      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 ">
        ...
        <div className="flex w-full flex-col px-6 gap-6 md:flex-row md:items-center md:justify-between">
          ...
          <div className="mt-2 flex-shrink-0 md:mt-0">
            <Link to="/signup" className="rounded-md bg-[var(--color-primary)] px-6 py-3 text-sm font-normal text-gray-50 transition-all duration-200 hover:opacity-90" aria-label="Explore properties">
              Explore Properties
            </Link>
          </div>
        </div>
