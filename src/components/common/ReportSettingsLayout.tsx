...
type ReportSettingsTab = "general";

interface ReportSettingsLayoutProps {
    activeTab: ReportSettingsTab;
    children: ReactNode;
...
export function ReportSettingsLayout(props: ReportSettingsLayoutProps) {
        ...
        <div className="min-h-screen bg-[#f5f5f5] px-4 py-6">
            <div className="max-w-6xl mx-auto space-y-5">
                <div className="text-sm text-gray-700 font-medium">
                    ...
                    / <span style={{ color: "#273F3B" }}>Reports</span>
                </div>
