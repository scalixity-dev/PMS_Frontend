...
export const API_ENDPOINTS = {
  ...
  SERVICE_PROVIDER: {
    ...
    GET_MY_DOCUMENTS: `${API_BASE_URL}/service-provider/me/documents`,
    ADD_MY_DOCUMENT: `${API_BASE_URL}/service-provider/me/documents`,
    UPDATE_MY_DOCUMENT: (documentId: string) => `${API_BASE_URL}/service-provider/me/documents/${documentId}`,
    DELETE_MY_DOCUMENT: (documentId: string) => `${API_BASE_URL}/service-provider/me/documents/${documentId}`,
    GET_MY_CONTACTS: `${API_BASE_URL}/service-provider/me/contacts`,
    ADD_MY_CONTACT: `${API_BASE_URL}/service-provider/me/contacts`,
    UPDATE_MY_CONTACT: (contactId: string) => `${API_BASE_URL}/service-provider/me/contacts/${contactId}`,
    DELETE_MY_CONTACT: (contactId: string) => `${API_BASE_URL}/service-provider/me/contacts/${contactId}`,
